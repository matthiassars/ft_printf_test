...
## Instructions
My own `ft_printf` repo is contained as a submodule. To run it with other `ft_printf` repos, make sure your `ft_printf` directory is in this directory. Compile with `make` and run with `./test`.
